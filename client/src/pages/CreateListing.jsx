...
export default function CreateListing() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            if(formData.imageUrls.length<1)return setError('You must uplaod at least one image')
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-6">
                        <div className="flex items-center gap-2">
                            <input type="number" name="" id="bedrooms" min="1" max="10" required 
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number" name="" id="regularPrice" min="50" max="1000000" required 
                            className="p-3 border border-gray-300 rounded-lg"
                            onChange={handleChange}
                        ...
                        {formData.offer&&
                        <div className="flex items-center gap-2">
                            <input type="number" name="" id="discountPrice" min="0" max="100000" required 
                            className="p-3 border border-gray-300 rounded-lg"
                            onChange={handleChange}
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            ...
                            className="cursor-pointer p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80"
                        >
                    ...
                    {formData.imageUrls.length > 0 &&
                        ...
                        <div key={url} className="flex justify-between p-3 border
                            ...
                            />
                            <button type="button" onClick={()=>handleRemoveImage(index)} className="cursor-pointer p-3 text-red-700 rounded-lg
                    ...
                    className="cursor-pointer p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
